...
pygame.display.set_caption("NEAT AI (Genetic Algorithm)")

class Car:
    def __init__(self):
        #Load Car Sprite and Rotate (Convert Speeds Up A Lot)
        self.sprite = pygame.image.load('../Images/neat-car.png').convert()
        self.sprite = pygame.transform.scale(self.sprite, (CAR_SIZE_X, CAR_SIZE_Y))
        self.rotated_sprite = self.sprite

        self.position = [885, 920]  # Starting Position
        self.angle = 0
        self.speed = 0
...
#Run the algorithm (simulation) to find best AI
...
if __name__ == "__main__":
    ...
    # Run Simulation For A Maximum of 15 Generations (is kept small for presentation)
